...
# longer array:
BARCOL_ARR=("${MORANGE}" "${MORANGE}" "${MORANGE}" "${MORANGE}" "${MORANGE}" "${MORANGE}" "${MORANGE}" "${MORANGE}" "${MORANGE}" "${MORANGE}" "${MORANGE}" "${MORANGE}" "${MORANGE}" "${MORANGE}" "${MORANGE}" "${MORANGE}" "${MORANGE}" "${MORANGE}" "${MORANGE}" "${MORANGE}" "${MORANGE}" "${MORANGE}" "${DORANGE}" "${DORANGE}" "${DORANGE}" "${DORANGE}" "${DORANGE}" "${DORANGE}" "${DORANGE}" "${DORANGE}" "${DORANGE}" "${DORANGE}" "${DORANGE}" "${DORANGE}" "${DORANGE}" "${DORANGE}" "${DORANGE}" "${DORANGE}" "${DORANGE}" "${DORANGE}" "${DORANGE}" "${DORANGE}" "${DORANGE}" "${DORANGE}" "${YELLOW}" "${YELLOW}" "${YELLOW}" "${YELLOW}" "${YELLOW}" "${YELLOW}" "${YELLOW}" "${YELLOW}" "${YELLOW}" "${YELLOW}" "${YELLOW}" "${YELLOW}" "${YELLOW}" "${YELLOW}" "${YELLOW}" "${YELLOW}" "${YELLOW}" "${YELLOW}" "${YELLOW}" "${YELLOW}" "${YELLOW}" "${YELLOW}" "${TEAL}" "${TEAL}" "${TEAL}" "${TEAL}" "${TEAL}" "${TEAL}" "${TEAL}" "${TEAL}" "${TEAL}" "${TEAL}" "${TEAL}" "${TEAL}" "${TEAL}" "${TEAL}" "${TEAL}" "${TEAL}" "${TEAL}" "${TEAL}" "${TEAL}" "${TEAL}" "${TEAL}" "${TEAL}" "${BCYAN}" "${BCYAN}" "${BCYAN}" "${BCYAN}" "${BCYAN}" "${BCYAN}" "${BCYAN}" "${BCYAN}" "${BCYAN}" "${BCYAN}" "${BCYAN}" "${BCYAN}" "${BCYAN}" "${BCYAN}" "${BCYAN}" "${BCYAN}" "${BCYAN}" "${BCYAN}" "${BCYAN}" "${BCYAN}" "${BCYAN}" "${BCYAN}" "${LBLUE}" "${LBLUE}" "${LBLUE}" "${LBLUE}" "${LBLUE}" "${LBLUE}" "${LBLUE}" "${LBLUE}" "${LBLUE}" "${LBLUE}" "${LBLUE}" "${LBLUE}" "${LBLUE}" "${LBLUE}" "${LBLUE}" "${LBLUE}" "${LBLUE}" "${LBLUE}" "${LBLUE}" "${LBLUE}" "${LBLUE}" "${LBLUE}" "${VBLUE}" "${VBLUE}" "${VBLUE}" "${VBLUE}" "${VBLUE}" "${VBLUE}" "${VBLUE}" "${VBLUE}" "${VBLUE}" "${VBLUE}" "${VBLUE}" "${VBLUE}" "${VBLUE}" "${VBLUE}" "${VBLUE}" "${VBLUE}" "${VBLUE}" "${VBLUE}" "${VBLUE}" "${VBLUE}" "${VBLUE}" "${VBLUE}" "${VLBLUE}" "${VLBLUE}" "${VLBLUE}" "${VLBLUE}" "${VLBLUE}" "${VLBLUE}" "${VLBLUE}" "${VLBLUE}" "${VLBLUE}" "${VLBLUE}" "${VLBLUE}" "${VLBLUE}" "${VLBLUE}" "${VLBLUE}" "${VLBLUE}" "${VLBLUE}" "${VLBLUE}" "${VLBLUE}" "${VLBLUE}" "${VLBLUE}" "${VLBLUE}" "${VLBLUE}" "${WHITE}" "${WHITE}" "${WHITE}" "${WHITE}" "${WHITE}" "${WHITE}" "${WHITE}" "${WHITE}" "${WHITE}" "${WHITE}" "${WHITE}" "${WHITE}" "${WHITE}" "${WHITE}" "${WHITE}" "${WHITE}" "${WHITE}" "${WHITE}" "${WHITE}" "${WHITE}" "${WHITE}" "${WHITE}" "${TERGREEN}" "${TERGREEN}" "${TERGREEN}" "${TERGREEN}" "${TERGREEN}" "${TERGREEN}" "${TERGREEN}" "${TERGREEN}" "${TERGREEN}" "${TERGREEN}" "${TERGREEN}" "${TERGREEN}" "${TERGREEN}" "${TERGREEN}" "${TERGREEN}" "${TERGREEN}" "${TERGREEN}" "${TERGREEN}" "${TERGREEN}" "${TERGREEN}" "${TERGREEN}" "${TERGREEN}" "${RED}" "${RED}" "${RED}" "${RED}" "${RED}" "${RED}" "${RED}" "${RED}" "${RED}" "${RED}" "${RED}" "${RED}" "${RED}" "${RED}" "${RED}" "${RED}" "${RED}" "${RED}" "${RED}" "${RED}" "${RED}" "${RED}" "${CHATREU}" "${CHATREU}" "${CHATREU}" "${CHATREU}" "${CHATREU}" "${CHATREU}" "${CHATREU}" "${CHATREU}" "${CHATREU}" "${CHATREU}" "${CHATREU}" "${CHATREU}" "${CHATREU}" "${CHATREU}" "${CHATREU}" "${CHATREU}" "${CHATREU}" "${CHATREU}" "${CHATREU}" "${CHATREU}" "${CHATREU}" "${CHATREU}" "${LGREEN}" "${LGREEN}" "${LGREEN}" "${LGREEN}" "${LGREEN}" "${LGREEN}" "${LGREEN}" "${LGREEN}" "${LGREEN}" "${LGREEN}" "${LGREEN}" "${LGREEN}" "${LGREEN}" "${LGREEN}" "${LGREEN}" "${LGREEN}" "${LGREEN}" "${LGREEN}" "${LGREEN}" "${LGREEN}" "${LGREEN}" "${LGREEN}" "${SLATE}" "${SLATE}" "${SLATE}" "${SLATE}" "${SLATE}" "${SLATE}" "${SLATE}" "${SLATE}" "${SLATE}" "${SLATE}" "${SLATE}" "${SLATE}" "${SLATE}" "${SLATE}" "${SLATE}" "${SLATE}" "${SLATE}" "${SLATE}" "${SLATE}" "${SLATE}" "${SLATE}" "${SLATE}" "${LYELLOW}" "${LYELLOW}" "${LYELLOW}" "${LYELLOW}" "${LYELLOW}" "${LYELLOW}" "${LYELLOW}" "${LYELLOW}" "${LYELLOW}" "${LYELLOW}" "${LYELLOW}" "${LYELLOW}" "${LYELLOW}" "${LYELLOW}" "${LYELLOW}" "${LYELLOW}" "${LYELLOW}" "${LYELLOW}" "${LYELLOW}" "${LYELLOW}" "${LYELLOW}" "${LYELLOW}" "${LMAGENTA}" "${LMAGENTA}" "${LMAGENTA}" "${LMAGENTA}" "${LMAGENTA}" "${LMAGENTA}" "${LMAGENTA}" "${LMAGENTA}" "${LMAGENTA}" "${LMAGENTA}" "${LMAGENTA}" "${LMAGENTA}" "${LMAGENTA}" "${LMAGENTA}" "${LMAGENTA}" "${LMAGENTA}" "${LMAGENTA}" "${LMAGENTA}" "${LMAGENTA}" "${LMAGENTA}" "${LMAGENTA}" "${LMAGENTA}" "${MAGENTA}" "${MAGENTA}" "${MAGENTA}" "${MAGENTA}" "${MAGENTA}" "${MAGENTA}" "${MAGENTA}" "${MAGENTA}" "${MAGENTA}" "${MAGENTA}" "${MAGENTA}" "${MAGENTA}" "${MAGENTA}" "${MAGENTA}" "${MAGENTA}" "${MAGENTA}" "${MAGENTA}" "${MAGENTA}" "${MAGENTA}" "${MAGENTA}" "${MAGENTA}" "${MAGENTA}" "${HIRed}" "${HIRed}" "${HIRed}" "${HIRed}" "${HIRed}" "${HIRed}" "${HIRed}" "${HIRed}" "${HIRed}" "${HIRed}" "${HIRed}" "${HIRed}" "${HIRed}" "${HIRed}" "${HIRed}" "${HIRed}" "${HIRed}" "${HIRed}" "${HIRed}" "${HIRed}" "${HIRed}" "${HIRed}" "${HIGreen}" "${HIGreen}" "${HIGreen}" "${HIGreen}" "${HIGreen}" "${HIGreen}" "${HIGreen}" "${HIGreen}" "${HIGreen}" "${HIGreen}" "${HIGreen}" "${HIGreen}" "${HIGreen}" "${HIGreen}" "${HIGreen}" "${HIGreen}" "${HIGreen}" "${HIGreen}" "${HIGreen}" "${HIGreen}" "${HIGreen}" "${HIGreen}" "${HIYellow}" "${HIYellow}" "${HIYellow}" "${HIYellow}" "${HIYellow}" "${HIYellow}" "${HIYellow}" "${HIYellow}" "${HIYellow}" "${HIYellow}" "${HIYellow}" "${HIYellow}" "${HIYellow}" "${HIYellow}" "${HIYellow}" "${HIYellow}" "${HIYellow}" "${HIYellow}" "${HIYellow}" "${HIYellow}" "${HIYellow}" "${HIYellow}" "${HIBlue}" "${HIBlue}" "${HIBlue}" "${HIBlue}" "${HIBlue}" "${HIBlue}" "${HIBlue}" "${HIBlue}" "${HIBlue}" "${HIBlue}" "${HIBlue}" "${HIBlue}" "${HIBlue}" "${HIBlue}" "${HIBlue}" "${HIBlue}" "${HIBlue}" "${HIBlue}" "${HIBlue}" "${HIBlue}" "${HIBlue}" "${HIBlue}" "${HIPurple}" "${HIPurple}" "${HIPurple}" "${HIPurple}" "${HIPurple}" "${HIPurple}" "${HIPurple}" "${HIPurple}" "${HIPurple}" "${HIPurple}" "${HIPurple}" "${HIPurple}" "${HIPurple}" "${HIPurple}" "${HIPurple}" "${HIPurple}" "${HIPurple}" "${HIPurple}" "${HIPurple}" "${HIPurple}" "${HIPurple}" "${HIPurple}" "${HICyan}" "${HICyan}" "${HICyan}" "${HICyan}" "${HICyan}" "${HICyan}" "${HICyan}" "${HICyan}" "${HICyan}" "${HICyan}" "${HICyan}" "${HICyan}" "${HICyan}" "${HICyan}" "${HICyan}" "${HICyan}" "${HICyan}" "${HICyan}" "${HICyan}" "${HICyan}" "${HICyan}" "${HICyan}")
